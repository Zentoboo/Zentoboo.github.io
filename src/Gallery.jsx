    ...
    return (
        <div className="relative min-h-screen">
            ...
            <div className="relative z-10">
                ...
                {/* Gallery Grid */}
                <div className="max-w-6xl px-12 mx-auto pb-16">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 transition-opacity duration-200">
